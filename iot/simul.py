...
while True:
    ...
    random_value1 = random.randint(min1, max1)
    random_value2 = random.randint(min2, max2)
    random_value3 = random.randint(min3, max3)
    random_value4 = random.uniform(min4, max4)
    random_value5 = random.uniform(min5, max5)
    random_value6 = random.randint(min6, max6)
    random_value7 = random.uniform(min, max)
    random_value8 = random.randint(min1, max1)
    random_value9 = random.randint(min2, max2)
    random_value10 = random.randint(min3, max3)
    ...
    "location_A": {
        ...
        "humidity": {
            "sensor": "humidity",
            "value": 40 # Assuming percentage humidity
        }
    },
